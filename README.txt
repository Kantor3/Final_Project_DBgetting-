...
Задачу масштабирована для использования для всех кабинетров школы 
В процессе разработки учтены замечания и рекаментации преподавателя Марины Орловой

Содержание проекта:
1. Схема структуры БД
2. Скрипт создания БД SQL в натации PostgreSQL 